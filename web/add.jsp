...
<head>
	<title> Register Page </title>
        <link rel="icon" href="assests/images/favicon.ico" type="x/image"/>
	...
	<center><h2>Registration page </h2></center>
		...
		<tr>
			...
			<td>Confirm Password</td>
                        <td><input type="password" name="cpassword" id="cpassword" required="required" class="form-control"></td>
		</tr>
		<tr>
			<td>Enter Age</td>
		...
		<tr>
			<td>Select Gender </td>
			<td>
				<input type="radio" name="gender" value="Male" value="Male" ${person.gender eq "Male" ? "checked": ""} />Male
				<br/>
