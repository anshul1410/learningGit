<%-- 
    Document   : Shownews
    Created on : Mar 6, 2020, 1:09:34 AM
...
<html>
    <head>
        ...
        <body>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <%
                            ...
                            ArrayList<News> category = new ArrayList();
                            category = ndo.getCategory();
           ...
           }%>" class="btn btn-dark"><a href="Shownews.jsp?start=<%=end * i%>">Page <%=i + 1%></a></span> 
                <%}
                %>
            </center>
            <span style="float:left"><a href="Shownews.jsp?start=<%=start - end%>" class="btn btn-primary <% if (start == 0) {
              out.println(" disabled");
          }%> ">PREVIOUS</a></span>

            <span style="float:right"><a href="Shownews.jsp?start=<%=start + end%>" class="btn btn-primary <% if (start + end >= total) {
                out.println(" disabled");
            }%> ">NEXT</a></span>
